...
const BookSection: React.FC<SectionProps> = ({ className }) => {
	...
	return (
		<div className={`container max-w-5xl mx-auto px-4 ${className}`}>
			...
			<div className="container max-w-5xl mx-auto mt-7 mb-7">
	...
	return (
		<div className="container mx-auto px-4 mt-4">
			<Card
				...
				isPressable
			>
				<h3 className="text-6xl mb-3">Full press release text</h3>
	...
	return (
		<div className="container mx-auto px-4 mt-4">
			<Card
				...
				style={{
					background:
						"linear-gradient(to right top, rgb(255 215 0 / 29%), rgb(0 0 255 / 28%))",
				}}
			>
				<TopLeftSvgAccent />
				<BottomRightSvgAccent />
				<div className="relative">
					<h3 className="text-6xl p-3">Introduction</h3>
					...
					<div className="p-3">
						<p className="text-3xl font-medium mt-3">Solomon Pournia, MD</p>
		...
		<>
			<section className="flex flex-col items-center justify-center gap-5 pt-8 pb-5 md:pt-10 pb-8">
				...
				<section className="py-0 w-full relative">
					<div className="container mx-auto px-4 mt-4">
						<Card className="p-6 bg-slate-200 dark:bg-gray-950" isHoverable>
