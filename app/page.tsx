      ...
      <div className={`h-full ${className}`}>
        ...
        <div className="relative flex flex-wrap h-full">
          ...
          <div className="p-3 self-end">
            ...
            <p className="text-lg">Los Angeles, December 2019</p>
          </div>
        </div>
      </div>
      <Modal
      ...
      <div className="h-full">
        <div className="relative flex flex-wrap h-full">
          ...
          <div className="p-3 self-end">
            ...
            <p className="text-lg">Los Angeles, Winter 2022</p>
          </div>
        </div>
      </div>
    ...
    <div className="text-center">
      <div>
        <span className="relative inline-flex px-3 py-2 rounded-3xl">
          <span className="relative z-10 text-xs font-medium">Introducing</span>
          ...
          content={
            <div className="max-w-sm">
              ...
              <p>
                ...
                development and protection of a Jewish nation in what is now
                Israel. It was established as a political organization in 1897
                under Theodor Herzl, and was later led by Chaim Weizmann.
              </p>
            </div>
          }
        >
        ...
        <Tooltip
          ...
          content={
            <div className="max-w-sm">
              ...
              Israel and Judah, two related kingdoms that emerged in the Levant
              during the Iron Age.
            </div>
          }
        >
...
export default function Home() {
  ...
  return (
    <>
      <section className="flex flex-col items-center justify-center gap-5 pt-8 md:pt-10 bg-white lg:rounded-b-[120px] rounded-b-[40px] after:content-[''] after:block after:w-3/4 after:h-[1px] after:mx-auto after:[background:linear-gradient(to_right,_transparent,_#37eada,_transparent)] overflow-hidden">
        <Hero />
      </section>
      <section className="">
        <BookSection className="mt-6" />
      </section>
      <div className="before:bg-gray-100/70 before:h-[40px] before:w-full before:absolute relative">
        <Spotlight className="mt-8 mx-auto grid grid-cols-12 gap-4  items-start lg:max-w-none group">
          <div className="col-span-12 bg-white lg:rounded-b-[120px] rounded-b-[40px] after:content-[''] after:block after:w-3/4 after:h-[1px] after:mx-auto after:[background:linear-gradient(to_right,_transparent,_#37eada,_transparent)] overflow-hidden">
            ...
            <div className="grid col-span-12 grid-cols-12 gap-4 justify-center max-w-3xl mx-auto pb-6 mt-4">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-12 col-span-12 gap-4">
          <Spotlight className="mt-8 mx-auto grid grid-cols-12 gap-4 col-span-12 items-start lg:max-w-none group">
            {/* Introduction */}
              ...
              <div className="relative h-full bg-white dark:bg-gray-900 w-full h-full flex items-center justify-center flex-col flex-wrap rounded-[inherit] z-20 overflow-hidden">
                <div className="marquee" style={{ "--gap": "1rem" }}>
                  <div className="marquee__group" style={{ "--gap": "1rem" }}>
                    <div className="text-4xl dahlia-font gradient-text">✺</div>
